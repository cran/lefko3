...
![Figure 5.2. Histogram of Cypripedium candidum size in time t](Ch5.4-1.png)
...
![Figure 5.3. Histogram of Cypripedium candidum fecundity in time t](Ch5.5-1.png)
...
#### Step 3b. Size and fecundity distributions
  ...
  <p style="text-indent: 20px">Package `lefko3` includes a function that can help in determining which distributions to use; `sf_distrib()`. Here, we use this function on our data. Earlier in this vignette, we used it to determine that we should use the negative binomial for size, and the zero-inflated negative binomial for fecundity.</p>
...
![Figure 5.5. Images of ahistorical vs. historical matrix means](Ch5.24-1.png)
...
![Figure 5.5. Images of ahistorical vs. historical matrix means](Ch5.24-2.png)
...
![Figure 5.6. Ahistorical vs. historical lambda](Ch5.28-1.png)
...
#> 1   1     1 -0.1023553 0.001794935 0.04236667 0.0004236667
slambda3(cypmatrix3)
#>   pop patch           a        var         sd           se
#> 1   1     1 -0.05874882 0.00148659 0.03855632 0.0003855632
```
...
![Figure 5.7. Ahistorical vs. historically-corrected stable stage distribution](Ch5.30-1.png)
...
![Figure 5.8. Ahistorical vs. historically-corrected reproductive values](Ch5.31-1.png)
...
![Figure 5.10. Ahistorical vs. historically-corrected elasticity of lambda to transitions](Ch5.36-1.png)
...
![Figure 5.11. Elasticity of lambda to historical transitions](Ch5.37-1.png)
