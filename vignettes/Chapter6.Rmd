...
```
  ...
  <p style="text-indent: 20px">These are giant matrices. With 10,609 rows and columns, there are a total of 112,550,881 elements per matrix. But they are also amazingly sparse - with 1,061,308 elements estimated, only 0.9% of elements per matrix are non-zero. Let's now build the ahistorical IPMs.</p>
...
#>   pop patch          a         var         sd          se
#> 1   1     1 -0.1501272 0.007987254 0.08937144 0.002826173
```
